...
// Coloque o número que represente o esporte do seu grupo (Exemplo: 0 para Ginástica, 1 para Judô, etc.)
const escolha = 0; 
...
// Crie uma função podiumMedalhas e verifique a quantidade de pontos
